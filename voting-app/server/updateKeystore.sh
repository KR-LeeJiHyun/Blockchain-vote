...
ORG_1_KEYSTORE=$(ls /tmp/hyperledger/org1/admin/msp/keystore)
...
ORG_2_KEYSTORE=$(ls /tmp/hyperledger/org2/admin/msp/keystore)

ORG_1_PATH_TO_KEYSTORE="tmp/hyperledger/org1/admin/msp/keystore/"
ORG_2_PATH_TO_KEYSTORE="tmp/hyperledger/org2/admin/msp/keystore/"
...
sed -i -e "s|tmp/hyperledger/org1/admin/msp/keystore/.*|$UPDATED_KEYSTORE_ORG_1|g" connection.yaml

echo 'updating connection.yaml Org2 adminPrivateKey path with' ${UPDATED_KEYSTORE_ORG_2}

sed -i -e "s|tmp/hyperledger/org2/admin/msp/keystore/.*|$UPDATED_KEYSTORE_ORG_2|g" connection.yaml
